...
\node[anchor = west, gray!75] at (2,0.808) {\scriptsize $ \langle\Lambda(\tau)f,f\rangle = \langle\Lambda(\sigma)f,f\rangle$};
...
\end{tikzpicture}
\caption{Two dimensional example of the feasible set $K_{\sigma}$.}
